...
public class FractalExplorer {
    ...
    */
    ...
    private class MouseHandler extends MouseAdapter
    {
        ...
        */
        ...
        public void mouseClicked(MouseEvent e)
        {
            ...
            if (rowsRemaining != 0) {
                //приложение будет реагировать на щелчки мышью только в том случае, если больше нет строк, которые должны быть нарисованы.
                return;
            }
    ...
    private class FractalWorker extends SwingWorker<Object, Object>
    {
        ...
        int yCoordinate;
        //массив чисел типа int для хранения вычисленных значений RGB для каждого пикселя в этой строке
        int[] arrayRGB;
        //Конструктор принимает координату y в качестве аргумента и сохраняет ее
        private FractalWorker(int row) {
            yCoordinate = row;
        }
        //Метод вызывается в фоновом потоке и отвечает за выполнение длительной задачи (юыл в drawFractal)
        ...
        //Вызывается после завершения фоновой задачи. Рисует пиксели для текущей строки и обновляет отображение
        protected void done() {
            //Рисование в пикселях, которые были вычислены в doInBackground ()
            for (int i = 0; i < arrayRGB.length; i++) {
